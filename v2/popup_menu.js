const GEMINI_API_KEY = "AIzaSyDg7PS6BbLx0iX6Vp9_YIuEq5iUnc-DWEI";
...
async function summarizeText(text) {
    ...
    5.**Research Gap analysis**: As an expert scientific researcher find out the research gap in this paper and write 3/4 line about that. 
    6. **Literature Review**: Write 3/4 line professional literature review from that research paper with main findings, key data points, methodology, important nsights.
    7. **Provide citation ready**: Provide citation ready of that paper as APA/IEEE format for readers.
